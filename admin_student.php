...
<head>
	...
	<body class="body2">
		...
		<div class="button">
        	<a href="user_edit.php?id=<?php echo $row['id']; ?>">Edit</a><br>
        	<a href="/student_data/home_page.php">Back</a><br>
        	<a href="inc/logout.php">Logout</a>
        </div>
		<div class="studentdata">
			<div class="name"><h1><?php echo $row['users_name']; ?></h1></div>
			<div class="stable">
				<div class="id"><h4><?php echo $row['id']; ?></h4></div>
				<div class="roll"><h4><?php echo $row['roll']; ?></h4></div>
				<div class="dep"><h4><?php echo $row['dep']; ?></h4></div>
			</div>
			<div class="disc"><h4>Reg.no : <?php echo $row['regno']; ?>, <?php echo $row['dis']; ?></h4></div>
		</div>
